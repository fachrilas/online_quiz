	...
	function share_button( $type='', $args=array() ){
		...
		if( $type == 'twitter'){
			if( isset($args['iframe']) ){
				...
				$button = <<<DOT
				<iframe allowtransparency="true" frameborder="0" scrolling="no" style="margin-left: 10px;position: relative;top: 5px;width:130px; height:50px;"
...
DOT;
				...
				$button = <<<DOT
				<a style="margin-left: 10px;position: relative;top: 5px;" href="http://twitter.com/share" class="twitter-share-button" {$param}>Tweet</a>
