...
<div class="row">
    <div class="col-md-4">
        <div class="package" style="background-image: url('<? echo base_url().'../assets/img/PricePlans_monthly_meox.png'?>');">
            ...
            <p><b>$14.95</b><br><i>Per Month</i></p><br><br>
    ...
    <input type="hidden" name="item_name" value="<?=GOLD_IEM?>">
...
{
?>
    <input type="image" src="<?=base_url()?>../assets/img/buy_now_m.png" width="100px" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
    </form>
            <? }else { ?>
          
                  <img src="<?=base_url()?>../assets/img/buy_now_m.png" data-toggle="modal" data-target="#myModal"/>
        <? } ?>
        </div>
</div>
<div class="col-md-4">
     <div class="package" style="background-image: url('<? echo base_url().'../assets/img/PricePlans_half_yearly_meox.png'?>');">
            <h2>Monthly<br>Subscription</h2>
            <p><b>$14.95</b><br><i>Per Month</i></p><br><br>
                  <img src="<?=base_url()?>../assets/img/buy_now_h_y.png" />
        </div>
</div>
<div class="col-md-4">
     <div class="package" style="background-image: url('<? echo base_url().'../assets/img/PricePlans_yearly_meox.png'?>');">
            <h2>Monthly<br>Subscription</h2>
            <p><b>$14.95</b><br><i>Per Month</i></p><br><br>
                  <img src="<?=base_url()?>../assets/img/buy_y.png" />
        </div>
</div>
</div>
